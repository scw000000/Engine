  ...
  //       this.Font = new System.Drawing.Font("Microsoft Sans Serif", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
   //      this.ItemSize = new System.Drawing.Size(30, 24);
      ...
      protected override void OnControlAdded( ControlEventArgs e )
         ...
         SizeF size = g.MeasureString( curTab.Text, curTab.Font, 50 );
         if( m_MaxStringLength < size.Width )
            {
            m_MaxStringLength = size.Width;
            this.ItemSize = new Size( Math.Max( m_MinTabSize, (int) m_MaxStringLength + this.ItemSize.Height + 20 ), this.ItemSize.Height );
              ...
              for (int nIndex = 0; nIndex < this.TabCount; nIndex++)
              {
                  if (nIndex != this.SelectedIndex)
                  {
                      ...
                      using (LinearGradientBrush _Brush = new LinearGradientBrush(tabTextArea, SystemColors.Control, SystemColors.ControlLight, LinearGradientMode.Vertical))
                      {
                       ...
                       //   e.Graphics.FillRectangle( _Brush, tabTextArea.X + tabTextArea.Width - outerCloseBtnWidth - 2, 2, outerCloseBtnWidth, outerCloerBtnHeight );
                       //   e.Graphics.DrawRectangle( Pens.White, 
                       //      tabTextArea.X + tabTextArea.Width - outerCloseBtnWidth - 2 + m_CloseRectHorDistance, 
                       //      10 + m_CloseRectVerDistance, 
                       //      outerCloseBtnWidth - m_CloseRectHorDistance * 2,
                       //      outerCloerBtnHeight - m_CloseRectVerDistance * 2 );
                       //   using (Pen pen = new Pen(Color.White, 2))
                       //   {
                       //e.Graphics.DrawLine( pen, tabTextArea.X + tabTextArea.Width - tabTextArea.Height - 8, 9, tabTextArea.X + tabTextArea.Width - tabTextArea.Height + 7, 17 );
                  ...
                  else
                  {
                      ...
                      //    e.Graphics.FillRectangle( _Brush, outerCloseBtnX, outerCloseBtnY, outerCloseBtnWidth, outerCloerBtnHeight );
                      //    float innerCloseBtnWidth = outerCloseBtnWidth - m_CloseRectHorDistance * 2;
                      //    float innerCloerBtnHeight = outerCloerBtnHeight - m_CloseRectVerDistance * 2;
                      //    float innerCloseBtnX = outerCloseBtnX + m_CloseRectHorDistance;
                      //    float innerCloseBtnY = outerCloseBtnY + m_CloseRectVerDistance;
                      ...
                      //using (Pen pen = new Pen(Color.White, 2))
                      //    {
                      // e.Graphics.DrawLine( pen, innerCloseBtnX, innerCloseBtnY, innerCloseBtnX + innerCloseBtnWidth, innerCloseBtnY + innerCloerBtnHeight );
                      // e.Graphics.DrawLine( pen, innerCloseBtnX, innerCloseBtnY + innerCloerBtnHeight, innerCloseBtnX + innerCloseBtnWidth, innerCloseBtnY );
                      //    }
                          if (CanDrawMenuButton(nIndex))
                          {
                              //Drawing menu button
                 ...
                 // e.Graphics.DrawString(str, this.Font, new SolidBrush(this.TabPages[nIndex].ForeColor), tabTextArea, stringFormat);
                  e.Graphics.DrawString( this.TabPages[ e.Index ].Text, e.Font, Brushes.Black, e.Bounds.Left + 5, e.Bounds.Top + 6 );
      ...
      protected override void OnMouseMove(MouseEventArgs e)
      {
          ...
          if (!DesignMode)
          {
              ...
              for (int nIndex = 0; nIndex < this.TabCount; nIndex++)
              {
                  ...
                  tabTextArea =
                      new RectangleF( outerCloseBtnX, outerCloseBtnY, outerCloseBtnWidth,
                                     outerCloerBtnHeight );
