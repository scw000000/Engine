...
Vec3 BoxCollider::VSupportMapping( const Vec3& direction )
   ...
   float localPointX = localDir.x > 0.f ? m_HalfSize.x : -m_HalfSize.x;
   float localPointY = localDir.y > 0.f ? m_HalfSize.y : -m_HalfSize.y;
   float localPointZ = localDir.z > 0.f ? m_HalfSize.z : -m_HalfSize.z;
