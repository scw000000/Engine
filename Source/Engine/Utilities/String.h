...
//save current warning setting into a stack, because we will modify the setting
//immediately, latter we will retore the setting by using pop
#pragma warning(push)
//disable warning message 4311
